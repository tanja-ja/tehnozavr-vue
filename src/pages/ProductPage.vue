...
<template>
       ...
       <button class="loader_btn" @click.prevent="loadProduct">Попробуйте обновить страницу</button>
        </main>
    ...
    <section class="item">
      <div class="item__pics pics">
        <div class="pics__wrapper">
          <img width="300" height="400" :src="product.image" :alt="product.title">
        </div>
      </div>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                ...
                <label class="colors__label" >
                  <input class="colors__radio sr-only" type="radio" v-model="color.id">
                  <span class="colors__value" :style="{'background-color': color.code, 'border': fontSize + 'px', borderStyle} ">
                  </span>
                </label>
              </li>
              </ul>
            ...
            <div class="item__row">
              <BaseAmount v-model="productAmount" :amount="this.productAmount"/>
            ...
            <div v-if="productAddSending" class="loader" ></div>
          </form>
        </div>
      </div>
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <h3>Что это?</h3>
          <p>
            Wahoo ELEMNT BOLT GPS – это велокомпьютер, который позволяет оптимизировать свои велотренировки, сделав их максимально эффективными. Wahoo ELEMNT BOLT GPS синхронизируется с датчиками по ANT+, объединяя полученную с них информацию. Данные отображаются на дисплее, а также сохраняются на смартфоне. При этом на мобильное устройство можно установить как фирменное приложение, так и различные приложения сторонних разработчиков. Велокомпьютер точно отслеживает местоположение, принимая сигнал с целого комплекса спутников. Эта информация позволяет смотреть уже преодоленные маршруты и пn ланировать новые велопрогулки.
          </p>
          <h3>Дизайн</h3> 
          <p>
...
import BaseAmount from '@/components/BaseAmount.vue';
